...
Gx, Gy, P_predict, TotalTimeCost = Optimization_ErGOT(x, y, IterNum=10, tau=2, n_samples=10, epochs=1000, lr=0.5, epsilon=500, alpha = 0.2, ones = 1, PlotLoss=False, Trick=True)
